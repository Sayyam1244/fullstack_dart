...
class Todo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Todo', createEmptyInstance: create)
    ...
    ..aOB(4, _omitFieldNames ? '' : 'isCompleted', protoName: 'isCompleted')
...
class TodoQuery extends $pb.GeneratedMessage {
  factory TodoQuery({
    $core.int? id,
  }) {
    final $result = create();
  ...
  TodoQuery._() : super();
  factory TodoQuery.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TodoQuery.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TodoQuery', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TodoQuery clone() => TodoQuery()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TodoQuery copyWith(void Function(TodoQuery) updates) => super.copyWith((message) => updates(message as TodoQuery)) as TodoQuery;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TodoQuery create() => TodoQuery._();
  TodoQuery createEmptyInstance() => create();
  static $pb.PbList<TodoQuery> createRepeated() => $pb.PbList<TodoQuery>();
  @$core.pragma('dart2js:noInline')
  static TodoQuery getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TodoQuery>(create);
  static TodoQuery? _defaultInstance;
...
class Todos extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Todos', createEmptyInstance: create)
